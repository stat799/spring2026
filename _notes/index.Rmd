...
<style>
  ...
  .syllabus-table tbody tr:nth-of-type(even) {
...
<table class="syllabus-table">
  ...
  <tbody>
    <tr>
      <td>01/26</td>
      <td>Statistical modeling. Continuous and categorical predictors. Review of mean, variance, and covariance. Types of uncertainty and sources of uncertainty.</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>01/27</td>
      <td>Linear mixed models I. Model diagnostics and model selection.</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>01/28</td>
      <td>Linear mixed models II. Model diagnostics and model selection.</td>
      <td class="kahoot-yes">Yes</td>
    </tr>
    <tr>
      <td>01/29</td>
    ...
    <tr>
      <td>01/30</td>
      <td>Non-linear mixed models I.</td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      <td>02/02</td>
      <td>Troubleshooting in mixed models fitting using R software. Computational and analytical solutions.</td>
      <td class="kahoot-yes">Yes</td>
    </tr>
    <tr>
      <td>02/03</td>
      <td>Generalized linear mixed models I. Beta, Binomial.</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>02/04</td>
      <td>Statistical power in designed experiments</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>02/05</td>
      <td>Statistical inference. Scientific writing. Dos & don’ts.</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>02/06</td>
    ...
    <tr>
      <td>02/09</td>
      <td>Optional: Bayesian modeling & inference</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>02/10</td>
      <td>Optional: Bayesian modeling & inference II</td>
      <td>&nbsp;</td>
    </tr>
  </tbody>
</table>
